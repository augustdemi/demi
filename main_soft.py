...
from data_generator_soft import DataGenerator_soft
from maml_soft import MAML_soft
...
def main():
    ...
    data_generator = DataGenerator_soft(FLAGS.update_batch_size * 2, FLAGS.meta_batch_size)
    ...
    model = MAML_soft(dim_input, dim_output)
    if FLAGS.train:
