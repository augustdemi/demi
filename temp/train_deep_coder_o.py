...
parser.add_argument("-o","--output", type=str, default='./model_output/fera_final_init', help="files creaded from VAE")
parser.add_argument("-n","--nb_iter",type=int, default=10, help="number of VAE iterations")
parser.add_argument("-w","--warming",type=int, default=1, help="factor on kl loss")
parser.add_argument("-tr","--training_data",type=str, default='/gpu/homedirs/ml1323/project/robert_data/DATA_2/fera_va.h5', help="path to training data set")
parser.add_argument("-te","--test_data",type=str, default='/gpu/homedirs/ml1323/project/robert_data/DATA_2/fera_te.h5', help="path to test data set")
...
TR = ED.provider.flow_from_hdf5(args.training_data, batch_size, padding='same', type = 'train')
TE = ED.provider.flow_from_hdf5(args.test_data, batch_size, padding='same', type = 'test')
...
import numpy as np
for dat, dset in zip(['/gpu/homedirs/ml1323/project/robert_data/DATA_2/fera_va.h5','/gpu/homedirs/ml1323/project/robert_data/DATA_2/fera_te.h5'],['_va','_te']):

    TR = ED.provider.flow_from_hdf5(dat, batch_size, padding='same', type = 'val')
