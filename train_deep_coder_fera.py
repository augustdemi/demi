...
parser.add_argument("-tr","--training_data",type=str, default='/home/ml1323/project/robert_data/DATA_3/fera_va.h5', help="path to training data set")
parser.add_argument("-te","--test_data",type=str, default='/home/ml1323/project/robert_data/DATA_3/fera_te.h5', help="path to test data set")
...
model_train.fit_generator( # 레알 도는부분. 작업이 진짜 실행됨
        ...
        callbacks=[ # 트레인 한 후 실행될 것
            EE.callbacks.summary_multi_output(
                ...
                nb_batches=100,
                title = ['TR','TE'],
                log_dir = 'res_fera_'+str(args.warming).zfill(4)+'.csv',
            ),
            EE.callbacks.summary_vac_fera(
