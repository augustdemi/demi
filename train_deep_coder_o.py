...
parser.add_argument("-tr","--training_data",type=str, default='/home/ml1323/project/robert_data/temp/fera_te.h5', help="path to training data set")
parser.add_argument("-te","--test_data",type=str, default='/home/ml1323/project/robert_data/temp/fera_va.h5', help="path to test data set")
...
#TR = ED.providero.flow_from_hdf5(args.training_data, batch_size, padding='same', type = 'train')
...
#TE = ED.providero.flow_from_hdf5(args.test_data, batch_size, padding='same', type = 'test')
...
def generator_sub(dat_dict, aug, mod=0):
    while True:
...
model_train.fit_generator( # 레알 도는부분. 작업이 진짜 실행됨
        ...
        callbacks=[ # 트레인 한 후 실행될 것
            ...
            EE.callbacks.summary_vac(
                gen = generator_sub(TE,False), # data augment 되지 않은, 형태가 [img], [img, lab, img]인 데이터
