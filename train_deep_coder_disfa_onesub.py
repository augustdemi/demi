...
parser.add_argument("-tr","--training_data",type=str, default='/home/ml1323/project/robert_data/DISFA/kfold_detected/train1.h5', help="path to training data set")
parser.add_argument("-te","--test_data",type=str, default='/home/ml1323/project/robert_data/DISFA/kfold_detected/test1.h5', help="path to test data set")
parser.add_argument("-k","--kfold",type=int, default=4, help="for k fold")
...
out_1 = EE.layers.logREG(out_0_shape[0])(z_mean) # out_0_shape = y label값의 형태만큼, predicted label값을 regression으로 만들어낼거임.
...
def generator_sub(dat_dict, aug, mod=0):
    while True:
       ...
       # print(img.shape)
        #for i in range(0, 10):
        #    cv2.imwrite("frame%d.jpg" % i, img[i])
